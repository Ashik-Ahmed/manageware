...
const Footer = () => {
    return (
        <div>
            <footer class="footer p-10 bg-indigo-400 text-white">
                <div>
            ...
            <footer class="footer px-10 py-4 border-t bg-indigo-400 text-white border-base-300">
                <div class="items-center grid-flow-col text-left">
                    ...
                    <p>ManageWare Inc. <br />Bicycle manufacturer since 1992</p>
                </div>
